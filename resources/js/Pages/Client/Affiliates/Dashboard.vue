    ...
    <ClientLayout>
        ...
        <template v-else>
            <div class="grid md:grid-cols-4 gap-4 mb-6">
                ...
                <StatCard label="Balance" :value="'$' + (affiliate.balance || '0.00')">
                    <template #icon>
            ...
            <Card v-if="affiliate.withdrawn" title="Payout History" class="mt-4">
                <dl class="space-y-3">
                    <div class="flex justify-between">
                        ...
                        <dd class="text-[13px] font-semibold text-gray-900">${{ affiliate.commissions || '0.00' }}</dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-[13px] text-gray-500">Withdrawn</dt>
                        <dd class="text-[13px] font-semibold text-gray-900">${{ affiliate.withdrawn || '0.00' }}</dd>
                    </div>
                    <div class="flex justify-between pt-2 border-t border-gray-100">
                        <dt class="text-[14px] font-semibold text-gray-900">Available Balance</dt>
                        <dd class="text-[14px] font-bold text-emerald-600">${{ affiliate.balance || '0.00' }}</dd>
                    </div>
                </dl>
            </Card>
        </template>
